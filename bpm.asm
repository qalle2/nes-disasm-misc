...
; external addresses in "bpm-fs.bin"
fs_init         equ famistudio+$0000
fs_play         equ famistudio+$00dd
fs_update       equ famistudio+$021b

; external addresses in "bpm-donut.bin"
donut_decomp    equ donut+$00ff
...
pt_devil        ; compressed BG PT data for Devil World (1012 bytes)
                ...
                ; uncompressed NT & AT data for 13 screens (all except for
                ; title screen and Donkey Kong; 1024 bytes each)

nt_devil        ; Devil World
...
nt_mario        ; Mario Bros.
                ...
                hex 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
                ;
                pad nt_mario+$400, $00  ; AT

nt_baseball     ; Baseball
                hex 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
                hex 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
                hex 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
                hex 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
                ...
                hex 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
                ;
                pad nt_baseball+$400, $00  ; AT

nt_dk3          ; Donkey Kong 3
                hex 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
                hex 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
                hex 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
                hex 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
                ...
                hex 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
                ;
                pad nt_dk3+$400, $00    ; AT

nt_dkjrmath     ; Donkey Kong Jr. Math
                hex 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
                hex 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
                hex 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
                hex 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
...
nt_popeye       ; Popeye
                ...
                hex 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
                ;
                pad nt_popeye+$400, $00  ; AT

nt_popeyeen     ; Popeye English
                hex 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
                hex 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
                hex 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
                hex 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
...
nt_tennis       ; Tennis
                ...
                hex 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
                ;
                pad nt_tennis+$400, $00  ; AT

nt_dkjr         ; Donkey Kong Jr.
                hex 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
                hex 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
                hex 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
                hex 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
...
famistudio      incbin "bpm-fs.bin"     ; Famistudio
                ...
                ; compressed BG PT data for screens except for Devil World
                ; ($8c72; 13045 bytes total)

pt_title_dk     ; title screen, Donkey Kong
...
pt_dkjrmath     ; Donkey Kong Jr. Math
                hex 03 2a 57 fe 82 c6 7c 38 73 7c fe 82 fe 7c 5e fe
                hex 1c 38 70 fe 09 5f fe 30 78 ec c6 82 51 fe 92 82
...
music_data      ; $c280; indirectly read by Famistudio
                ...
                hex 00 c0 02 cf 00 03 00 c0 be bd bd be bf c1 c2 c3
                hex c3 c2 00 01 fb 12 78 69 01 80 11 81 15 81 21 81
                hex 22 81 11 81 1d 81 11 81 1f 81 1d 81 11 81 18 81
                hex 15 81 11 81 16 81 15 81 11 81 ff 1c 1a c3 11 81
                hex 15 81 69 01 ff 20 1a c3 ff 1c 1a c3 11 81 15 81
                hex 69 01 ff 20 1a c3 ff 1c 1a c3 11 81 15 81 69 01
                hex ff 20 1a c3 ff 1c 1a c3 11 81 15 81 69 01 11 81
                hex 16 81 19 81 20 81 0c 81 11 81 15 81 1d 81 0f 81
                hex 13 81 16 81 22 81 0a 81 0f 81 11 81 16 81 ff 20
                hex 6e c3 69 01 ff 20 1a c3 ff 1c 1a c3 11 81 15 81
                hex 69 01 ff 20 1a c3 ff 1c 1a c3 11 81 15 81 69 01
                hex ff 20 1a c3 ff 1c 1a c3 11 81 15 81 fd 16 c3 81
                hex 74 68 fd 69 03 ff 20 19 c3 ff 1c 1a c3 11 81 15
                hex 81 68 fd 69 03 ff 20 1a c3 ff 1c 1a c3 11 81 15
                hex 81 68 fd 69 03 ff 20 1a c3 ff 1c 1a c3 11 81 15
                hex 81 68 fd 69 03 ff 20 1a c3 ff 1c 1a c3 11 81 15
                hex 81 68 fd 69 03 ff 20 6e c3 ff 20 6e c3 68 fd 69
                hex 03 ff 20 1a c3 ff 1c 1a c3 11 81 15 81 68 fd 69
                hex 03 ff 20 1a c3 ff 1c 1a c3 11 81 15 81 68 fd 69
                hex 03 ff 20 1a c3 ff 1c 1a c3 11 81 15 fd bf c3 70
                hex f7 87 f7 87 7f 63 f8 c2 64 82 35 81 63 06 c3 8b
                hex 63 f8 c2 64 37 81 63 06 c3 8b 63 f8 c2 64 3f 81
                hex 63 06 c3 87 63 f8 c2 64 3e 3d 3c 81 63 06 c3 8b
                hex 63 f8 c2 64 41 81 63 06 c3 8b 63 f8 c2 64 3c 81
                hex 63 06 c3 87 63 f8 c2 64 3d 3e 3f 81 63 06 c3 8b
                hex 63 f8 c2 64 41 81 63 06 c3 8b 63 f8 c2 64 ff 1c
                hex 4a c4 63 f8 c2 64 41 81 63 06 c3 87 63 f8 c2 64
                hex 3c 81 63 f8 c2 64 3c 81 63 06 c3 85 3b 81 63 f8
                hex c2 64 3a 63 f8 c2 64 3a 81 63 06 c3 87 63 f8 c2
                hex 64 35 81 63 06 c3 37 81 63 f8 c2 64 38 81 63 06
                hex c3 37 81 63 f8 c2 64 3c 81 ff 16 a2 c4 63 f8 c2
                hex 64 33 81 63 f8 c2 64 ff 1c 4a c4 29 24 29 24 29
                hex 24 29 24 29 24 29 24 29 24 29 24 29 22 29 22 29
                hex 22 29 22 29 1f 29 1f 29 1f 29 1f ff 20 fb c4 ff
                hex 20 fb c4 ff 20 fb c4 fd 3f c4 f7 87 f7 87 f7 87
                hex f7 87 f7 87 f7 87 f7 87 f7 87 fd 2a c5 6a 02 05
                hex 8d 6a 02 0c 8d 6a 02 0a 8d 6a 02 07 8d 6a 02 11
                hex 8d 6a 02 0c 8d 6a 02 0a 8d 6a 02 07 8d ff 10 3d
                hex c5 ff 10 3d c5 ff 10 3d c5 6a 02 05 8d 6a 02 0c
                hex 8d 6a 02 0f 8d 6a 02 0a 8d 6a 02 11 8d 6a 02 0c
                hex 8d 6a 02 0f 8d 6a 02 0a 8d ff 10 3d c5 ff 10 3d
                hex c5 ff 10 3d c5 fd 3d c5
...
donut           incbin "bpm-donut.bin"  ; Donut ($d5cd)
                pad $ffd0, $00
